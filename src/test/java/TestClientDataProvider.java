...
public class TestClientDataProvider {
  public static final AuthenticationDTO FRANK_AUTH_CORRECT = AuthenticationDTO.valueOf("frank1", "login");
  public static final AuthenticationDTO FRANK_AUTH_FALSE = AuthenticationDTO.valueOf("frank1", "login");
  ...
  public static final CommunicatorDTO PETER_COMM_CORRECT = CommunicatorDTO.valueOf(15004,
      "Peter Relation4");
  public static final CommunicatorDTO MAX_COMM_CORRECT = CommunicatorDTO.valueOf(15005, "Max Status1");
  public static final CommunicatorDTO THOMAS_COMM_CORRECT = CommunicatorDTO.valueOf(15006,
      "Thomas Status2");
  public static final List<AuthenticationDTO> AUTH_CLIENT_LIST = of(FRANK_AUTH_CORRECT, MARKUS_AUTH_CORRECT);
